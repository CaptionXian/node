...
class HospitalCtrl extends Base {
    ...
    async exportExcel(ctx, next) {
        const _headers = [
          ...
          let rows = await this.getQuestionnaireDate(
            { type: 'clinic', isDeleted: false }
          )
    ...
    async getQuestionnaireDate(conds) {
        ...
        for(let questionnaire of questionnaires) {
            ...
            data.push(`${questionnaire.answer[0]['score']}/ ${questionnaire.answer[0]['content']}/ ${questionnaire.answer[0]['comment']}`)
            data.push(`${questionnaire.answer[1]['score']}/ ${questionnaire.answer[0]['content']}/ ${questionnaire.answer[0]['comment']}`)
            data.push(`${questionnaire.answer[2]['score']}/ ${questionnaire.answer[0]['content']}/ ${questionnaire.answer[0]['comment']}`)
            data.push(`${questionnaire.answer[3]['score']}/ ${questionnaire.answer[0]['content']}/ ${questionnaire.answer[0]['comment']}`)
            data.push(`${questionnaire.answer[4]['score']}/ ${questionnaire.answer[0]['content']}/ ${questionnaire.answer[0]['comment']}`)
            data.push(`${questionnaire.answer[5]['score']}/ ${questionnaire.answer[0]['content']}/ ${questionnaire.answer[0]['comment']}`)
            data.push(`${questionnaire.answer[6]['score']}/ ${questionnaire.answer[0]['content']}/ ${questionnaire.answer[0]['comment']}`)
            data.push(`${questionnaire.answer[7]['score']}/ ${questionnaire.answer[0]['content']}/ ${questionnaire.answer[0]['comment']}`)
            data.push(`${questionnaire.answer[8]['score']}/ ${questionnaire.answer[0]['content']}/ ${questionnaire.answer[0]['comment']}`)
            data.push(`${questionnaire.answer[9]['score']}/ ${questionnaire.answer[0]['content']}/ ${questionnaire.answer[0]['comment']}`)
            data.push(questionnaire.advantage)
            data.push(questionnaire.defect)
            data.push(questionnaire.created)
