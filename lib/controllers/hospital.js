...
class HospitalCtrl extends Base {
    ...
    async getQuestionnaireDate(conds) {
        ...
        for(let questionnaire of questionnaires) {
            ...
            data.push(`${questionnaire.answer[1]['score']}/ ${questionnaire.answer[1]['content']}/ ${questionnaire.answer[1]['comment']}`)
            data.push(`${questionnaire.answer[2]['score']}/ ${questionnaire.answer[2]['content']}/ ${questionnaire.answer[2]['comment']}`)
            data.push(`${questionnaire.answer[3]['score']}/ ${questionnaire.answer[3]['content']}/ ${questionnaire.answer[3]['comment']}`)
            data.push(`${questionnaire.answer[4]['score']}/ ${questionnaire.answer[4]['content']}/ ${questionnaire.answer[4]['comment']}`)
            data.push(`${questionnaire.answer[5]['score']}/ ${questionnaire.answer[5]['content']}/ ${questionnaire.answer[5]['comment']}`)
            data.push(`${questionnaire.answer[6]['score']}/ ${questionnaire.answer[6]['content']}/ ${questionnaire.answer[6]['comment']}`)
            data.push(`${questionnaire.answer[7]['score']}/ ${questionnaire.answer[7]['content']}/ ${questionnaire.answer[7]['comment']}`)
            data.push(`${questionnaire.answer[8]['score']}/ ${questionnaire.answer[8]['content']}/ ${questionnaire.answer[8]['comment']}`)
            data.push(`${questionnaire.answer[9]['score']}/ ${questionnaire.answer[9]['content']}/ ${questionnaire.answer[9]['comment']}`)
