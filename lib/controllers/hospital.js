...
class HospitalCtrl extends Base {
    ...
    async getQuestionnaireDate(conds) {
        ...
        for(let questionnaire of questionnaires) {
            ...
            data.push(`${questionnaire.answer[7]['score']} / ${questionnaire.answer[7]['content']} ${ _.isUndefined(questionnaire.answer[7]['comment']) ? '' : '/ '+questionnaire.answer[7]['comment']}`)
            data.push(`${questionnaire.answer[8]['score']} / ${questionnaire.answer[8]['content']} ${ _.isUndefined(questionnaire.answer[8]['comment']) ? '' : '/ '+questionnaire.answer[8]['comment']}`)
            data.push(`${questionnaire.answer[9]['score']} / ${questionnaire.answer[9]['content']} ${ _.isUndefined(questionnaire.answer[9]['comment']) ? '' : '/ '+questionnaire.answer[9]['comment']}`)
